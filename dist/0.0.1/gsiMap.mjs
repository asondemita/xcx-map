 ...
 * @type {string}
 */
var GSI_ELEVATION_API = 'https://cyberjapandata2.gsi.go.jp/general/dem/scripts/getelevation.php';
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  return _createClass(ExtensionBlocks, [{
    ...
    value: function getCurrentLocation() {
      ...
      return new Promise(function (resolve) {
        navigator.geolocation.getCurrentPosition(function (position) {
          ...
          _this2.currentLng = position.coords.longitude;
          resolve();
        }, function () {
          return resolve();
        }, {
    ...
    key: "elevation",
    value: function elevation(args) {
      var lat = Cast.toNumber(args.LAT);
      var lng = Cast.toNumber(args.LNG);
      if (typeof fetch === 'undefined') {
        return '';
      }
      var url = "".concat(GSI_ELEVATION_API, "?lon=").concat(lng, "&lat=").concat(lat, "&outtype=JSON");
