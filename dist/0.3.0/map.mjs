...
var en = {
	...
	"map.addPoint": "drop a pin at latitude [LAT] longitude [LNG]",
...
var ja = {
	...
	"map.addPoint": "地点 緯度 [LAT] 経度 [LNG] にピンを立てる",
...
var translations = {
	...
	"map.addPoint": "ちてん いど [LAT] けいど [LNG] にピンをたてる",
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  return _createClass(ExtensionBlocks, [{
    ...
    key: "_drawPin",
    value: function _drawPin(ctx, x, y) {
      var headR = 6;
      var headCy = y - 15;
